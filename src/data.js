      ...
      lastActiveUser: [
        {
          name: "Ankit",
          mobile: "4204204201",
          profilePic: require("./assets/ankit.jpg"),
        },
      ],
    },
      ...
      lastActiveUser: [
        {
          name: "Akash",
          mobile: "8463784838",
          profilePic: require("./assets/akash.jpg"),
        },
      ],
    },
    //-------6-----------------
    ...
    //---------1-------------------
    {
      ...
      chatsLists: [
        ...
        },
        {
          ...
          time: "03:01 PM",
          content:
            "Now i am working on  skill test , but can you guide me in my chat app to Make the redux data persistent such that after refresh, the messages and conversations are intact.",
          contentType: "text",
          chatId: 5,
        },
        {
