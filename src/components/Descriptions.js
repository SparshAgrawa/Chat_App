          ...
          <div className="descriptionContent">
            <div className="groupORContactHeading">
              ...
              <span className="contactNames">
                {currentContactOrGroup.contactOrGroupName}
              </span>
            </div>
            ...
            <div className="groupHeadingItem">
              <div className="roundedImageContainer">
                <img
                  src={currentContactOrGroup.groupAdmins[0].profilePic}
                  alt="user-pic"
                />
              </div>
              <span className="contactNames">
                {currentContactOrGroup.groupAdmins[0].name +
                  " ~ " +
                  currentContactOrGroup.groupAdmins[0].mobile}
              </span>
            ...
            <div className="groupHeadingItem">
              <div className="roundedImageContainer">
                <img
                  src={currentContactOrGroup.lastActiveUser[0].profilePic}
                  alt="user-pic"
                />
              </div>
              <span className="contactNames">
                {currentContactOrGroup.lastActiveUser[0].name +
                  " ~ " +
                  currentContactOrGroup.lastActiveUser[0].mobile}
              </span>
              <span className="contactsType">Last Active</span>
            </div>

            <button
              className="shoGroupMemberBtn"
              onClick={() =>
                this.handleShowGroupMemberBtnClick(
                  currentContactOrGroup.contactOrGroupId
                )
              }
            >
              Show Group Members...
          ...
          <div className="descriptionContent">
            <div className="groupORContactHeading">
              ...
              <span className="contactNames">
                {currentContactOrGroup.contactOrGroupName +
                  "~" +
                  currentContactOrGroup.mobileNumber}
              </span>
            </div>
          </div>
        )}
